...
class PageScreenBrightnessServiceTest < Minitest::Test
  ...
  def test_screen_brightness_setters_use_flet_payload_shape
    cases = {
      set_animate: [false, { "animate" => false }],
      set_auto_reset: [true, { "auto_reset" => true }],
      set_application_screen_brightness: [0.75, { "brightness" => 0.75 }],
      set_system_screen_brightness: [0.25, { "brightness" => 0.25 }]
    }
