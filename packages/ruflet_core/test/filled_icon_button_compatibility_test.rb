...
class RufletFilledIconButtonCompatibilityTest < Minitest::Test
  def test_filled_icon_button_accepts_positional_icon_and_serializes_current_flet_props
    button = Ruflet.filled_icon_button(
      "check",
      alignment: { x: 0, y: 0 },
      bgcolor: "#ABCDEF",
    ...
    assert_equal "FilledIconButton", patch["_c"]
  ...
  def test_filled_icon_button_defaults_match_flet
    button = Ruflet.filled_icon_button("check")
  ...
  def test_filled_icon_button_serializes_non_positive_splash_radius_like_flet
    assert_equal 0, Ruflet.filled_icon_button("check", splash_radius: 0).to_patch["splash_radius"]
    assert_equal(-1, Ruflet.filled_icon_button("check", splash_radius: -1).to_patch["splash_radius"])
  end

  def test_compact_alias_uses_same_control
    assert_equal "FilledIconButton", Ruflet.fillediconbutton("check").to_patch["_c"]
  end
end
