...
class RufletFilledIconButtonCompatibilityTest < Minitest::Test
  ...
  def test_filled_icon_button_rejects_non_positive_splash_radius_like_flet
    assert_raises(ArgumentError) { Ruflet.filled_icon_button("check", splash_radius: 0) }
    assert_raises(ArgumentError) { Ruflet.filled_icon_button("check", splash_radius: -1) }
  end
