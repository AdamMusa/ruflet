...
class RubyNativeBootstrapApp extends StatefulWidget {
  const RubyNativeBootstrapApp({
    super.key,
  ...
  @override
  State<RubyNativeBootstrapApp> createState() => _RubyNativeBootstrapAppState();
}
