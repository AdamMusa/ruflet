...
- Python class: `Accelerometer`
- Source: `sdk/python/packages/flet/src/flet/controls/services/accelerometer.py`
...
## Notes
- Extracted from `@control("Accelerometer")` class declaration.
