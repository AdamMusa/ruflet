  ...
  module SectionsMisc
    def build_charts(page, status)
      ...
      column(
        ...
        tight: true,
        children: [
          text(value: "BarChart", style: { size: 14, weight: "w600", color: "#e7e9ec" }),
          bar_chart,
          text(value: "LineChart", style: { size: 14, weight: "w600", color: "#e7e9ec" }),
          line_chart,
          text(value: "PieChart", style: { size: 14, weight: "w600", color: "#e7e9ec" }),
          pie_chart,
          text(value: "CandlestickChart", style: { size: 14, weight: "w600", color: "#e7e9ec" }),
          candlestick_chart,
          text(value: "RadarChart", style: { size: 14, weight: "w600", color: "#e7e9ec" }),
          radar_chart,
          text(value: "ScatterChart", style: { size: 14, weight: "w600", color: "#e7e9ec" }),
          scatter_chart
        ]
      )
    end
